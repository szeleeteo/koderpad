...
Write one Python function that accepts the list and returns new list with the following criteria:

- Include only students who are 18 or older.
- Include a new key "average_grade" that contains the average of their grades.
- Exclude the original "age" and "grades" key from the returned list.
"""
